...
1.  Developer cannot SSH using new user --- what to check? 👉
    authorized_keys permissions.

2.  NGINX installed but website not loading --- reason? 👉 Security
    Group port 80 blocked.

3.  SSH login slow --- troubleshooting? 👉 DNS lookup or security rules.
